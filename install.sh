...
start_aios() {
    ...
    info ""
    info "Launch the AI shell:      OS_ROOT=$OS_ROOT bash $OS_ROOT/bin/os-shell"
...
echo ""
echo "Next steps:"
echo "  1. Add a .gguf model to llama_model/  (see llama_model/README.md)"
echo "  2. Build llama.cpp:  bash build/build.sh --target hosted"
echo "  3. Start AIOS:       bash install.sh --start"
echo "  4. Run AI shell:     OS_ROOT=$OS_ROOT bash $OS_ROOT/bin/os-shell"
echo "  5. Run real shell:   OS_ROOT=$OS_ROOT bash $OS_ROOT/bin/os-real-shell"
echo ""
echo "  Run tests at any time:"
echo "    AIOS_HOME=$(pwd) OS_ROOT=$OS_ROOT bash tests/unit-tests.sh"
echo "    bash tests/integration-tests.sh"
echo "════════════════════════════════════════"
